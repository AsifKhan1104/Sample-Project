...
import com.bookpal.model.ChatUser;
import com.bookpal.model.Conversation;
...
public class Chat extends AppCompatActivity implements View.OnClickListener {
     ...
     */
    private ChatUser buddy = new ChatUser();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // buddy = (ChatUser) getIntent().getSerializableExtra(AppConstants.EXTRA_CHAT_DATA);

        buddy.setUsername(getIntent().getStringExtra("username"));
        buddy.setId(getIntent().getStringExtra("userid"));
